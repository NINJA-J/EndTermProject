...
//		SQLConnection con = new SQLConnection();
		...
		java.sql.Date date = new Date( 
				ccc.get(Calendar.YEAR) - 1900,
				ccc.get(Calendar.MONTH),
				ccc.get(Calendar.DAY_OF_MONTH) );
//		java.sql.Date date2 = new java.sql.Date( ccc.getTime() );
		
		System.out.println( ccc.getTime() );
		System.out.println( ccc.getTimeInMillis());
		System.out.println( date );
		System.out.println( date.getTime() );
		
		ccc.set( 2017, 2, 30 );
		
		date = new java.sql.Date( ccc.getTime().getTime() );
